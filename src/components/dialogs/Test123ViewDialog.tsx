...
interface Test123ViewDialogProps {
  open: boolean;
  onClose: () => void;
  record: Test123 | null;
  onEdit: (record: Test123) => void;
}

export function Test123ViewDialog({ open, onClose, record, onEdit }: Test123ViewDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Test 123 anzeigen</DialogTitle>
        </DialogHeader>
